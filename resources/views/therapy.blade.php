...
<div class="bg-gray-200">
    <div style="height: 42em;" class="mt-6">
        <div class="container mx-auto">
            <div class="grid grid-cols-12 grid-flow-row h-96">
                <div class="col-span-6">
                    <h3 class="font-bold text-4xl my-6">Tüm Tedavilerimiz</h3>
                    <ul>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Diş Çekimi</a></li>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Implant</a></li>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Diş Eti Tedavileri</a></li>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Dolgu</a></li>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Estetik Diş Hekimliği</a></li>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Diş Beyazlatma</a></li>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Zirkonyum</a></li>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Kanal Tedavisi</a></li>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Porselen</a></li>
                        <li class="mt-8 pl-2 border-l-2 border-gray-800"><a href="#">Çocuk Diş Hekimliği</a></li>
                    </ul>
                </div>
                <div class="col-span-6">
                    <div class="mt-6">
                        <img class="shadow-lg" src="{{ asset('images/slider-2.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
