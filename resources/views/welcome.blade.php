@include('layouts.header')
        ...
        <div class="container mx-auto h-screen">
            ...
            <div class="relative">
                <div class="grid grid-cols-8 grid-flow-row grid-rows-3 lg:block hidden ">
                ...
                <div id="mobile-menu" class="h-full w-full bg-white fixed top-0 left-0 px-12 pt-12 z-10 overflow-hidden hidden ">
                    ...
                    <hr>
                    <ul class="space-y-12">
                     <li class="mt-4 text-2xl list-none text-center"><a href="#">Anasayfa</a></li>
                        <li class="text-2xl list-none text-center"><a href="#">Hakkımızda</a></li>
                        <li class="text-2xl list-none text-center"><a href="#">Tedaviler</a></li>
                        <li class="text-2xl list-none text-center"><a href="#">Anlaşmalı Kurumlar</a></li>
                        <li class="text-2xl list-none text-center"><a href="#">Foto Galeri</a></li>
                        <li class="text-2xl list-none text-center"><a href="#">İnsan Kaynakları</a></li>
                        <li class="text-2xl list-none text-center"><a href="#">İletişim</a></li>
                    </ul>
                </div>

                {{-- mobile menu --}}

                <h3 class="text-5xl mt-24 text-gray-800 md:text-left text-center">
                    Haydi Birlikte<br>
                </h3>
                <div style="" class="text-7xl text-center md:ml-8 sm:ml-0 md:text-left sm:text-center font-serif text-gray-800 font-bold">Gülelim!</div>
                <p class="px-8 font-bold text-gray-800 mt-4 xl:w-2/6 lg:w-2/3 text-center md:text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi repudiandae officiis expedita, earum soluta ut praesentium mollitia doloremque? Eveniet accusamus mollitia fugit porro ipsa officiis cumque et odio beatae a.</p>
                <div class="md:mt-12 sm:mt-0 md:block flex justify-center"><a class="px-8 py-4 hover:bg-transparent bg-gray-800 rounded-md hover:text-gray-800 border-2 hover:border-gray-800 transition duration-300 text-white mt-10" href="#">Keşfetmeye Başla</a></div>
            </div>
        </div>
        ...
        <div class="container mx-auto">
            <div class="flex justify-between my-6 items-center">
                <div>
                    ...
                    <a style="background-color: #1fa2ff; border-color:#1fa2ff;" class="md:flex md:flex-row hidden py-4 px-8 text-white transition duration-300 border-2 rounded-md " href="#">
        ...
        <div style="background-image: url({{ asset('images/x.jpg') }})" class="bg-center bg-fixed md:py-4">
            <div class="container mx-auto">
                <div class="flex md:flex-row flex-col-reverse items-center px-4">
                    <div class="text-white text-center md:text-left">
                        <h3 class="text-center md:text-left font-bold">Kaliteli, Güvenilir ve <br> Sağlıklı Yaşam İçin Buradayız..</h3>
                    ...
                    <div class="">
                        <img class=" md:w-full mx-auto w-24" src="{{ asset('images/teeth.png') }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 grid-flow-row gap-4 w-full px-4 md:px-12">
            <div class="col-span-6 md:col-span-3">
                <img class="w-full h-32 md:h-64 object-cover rounded-md shadow-2xl" src="https://picsum.photos/600/175">
            </div>
